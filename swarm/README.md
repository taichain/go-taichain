...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/taichain/go-taichain

    go install github.com/taichain/go-taichain/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/taichain/go-taichain`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/taichain/go-taichain
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/taichain/go-taichain/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/taichain/go-taichain/wiki/Code-Review-Guidelines).

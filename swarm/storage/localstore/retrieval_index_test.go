...
//
// # go test -benchmem -run=none github.com/taichain/go-taichain/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/taichain/go-taichain/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/taichain/go-taichain/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/taichain/go-taichain/swarm/storage/localstore

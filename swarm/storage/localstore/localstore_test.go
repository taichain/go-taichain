...
import (
	...
	ch "github.com/taichain/go-taichain/swarm/chunk"
	"github.com/taichain/go-taichain/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/taichain/go-taichain/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64

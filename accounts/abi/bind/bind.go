...
//
// Detailed usage document and tutorial available on the The go-taichain Wiki page:
// https://github.com/taichain/go-taichain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/taichain/go-taichain/accounts/abi"
)

...
import (
	...
	"github.com/taichain/go-taichain/cmd/internal/browser"
...
const issueURL = "https://github.com/taichain/go-taichain/issues/new"

// reportBug reports a bug by opening a new URL to the The go-taichain GH issue

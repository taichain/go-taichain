...
// This test reproduces https://github.com/taichain/go-taichain/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("The go-taichain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
